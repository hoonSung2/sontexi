<template>
  <div class="backdrop" style="z-index: 9999;">
    <div class="modal" style="width: 1300px; height: 900px; z-index: 1550;"  @click="closeModal()">
...
export default {
  ...
  methods: {
    initMap() {
      ...
      this.taxi = new google.maps.MarkerImage("https://cdn-icons-png.flaticon.com/512/2557/2557954.png",null,null,null,new google.maps.Size(50,50));
      this.user = new google.maps.MarkerImage("https://cdn-icons-png.flaticon.com/512/1912/1912207.png",null,null,null,new google.maps.Size(45,45));
    ...
    signOutButtonPressed() {
      firebase
        ...
        .signOut()
        .then(() => {
          // vue-router를 사용하는 경우, 다음과 같이 경로를 변경합니다.
          this.$router.push({
            name: "Signin"
          });
        })
